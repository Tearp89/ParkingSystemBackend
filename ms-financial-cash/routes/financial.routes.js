...
router.get('/pending-summary/:branchId', verifyJWT, authorize('SUPERVISOR', 'ADMIN'), paymentController.getPendingSummary);
router.post('/general-closing', verifyJWT, authorize('SUPERVISOR', 'ADMIN'), paymentController.createGeneralClosing);
